...
var locationChange$ = new _rxjs.Observable(function (observer) {
  return history.listen(function () {
    return observer.next(readLocation());
  });
}).pipe((0, _operators.map)(function (location) {
  return {
    type: 'change',
    location: location
  };
...
function createLocationStore() {
  ...
  var eventStream = new _rxjs.Observable(function (observer) {
