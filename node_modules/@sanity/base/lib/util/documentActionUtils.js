...
var readActions = function readActions(schemaType) {
  return ACTIONS_FLAG in schemaType ? schemaType[ACTIONS_FLAG] : DEFAULT_ACTIONS;
};

var validateActions = function validateActions(typeName, actions) {
...
var resolveEnabledActions = function resolveEnabledActions(schemaType) {
  return validateActions(schemaType.name, readActions(schemaType));
};

exports.resolveEnabledActions = resolveEnabledActions;

var isActionEnabled = function isActionEnabled(schemaType, action) {
