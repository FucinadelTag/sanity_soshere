...
class VisionGui extends _react.default.PureComponent {
  ...
  handlePaste(evt) {
    ...
    const qs = _queryString.default.parse(urlQuery);
  ...
  handleListenExecution() {
    ...
    const url = client.getUrl(client.getDataUrl('listen', (0, _encodeQueryString.default)(query, params)));
  ...
  handleQueryExecution() {
    ...
    const url = client.getUrl(client.getDataUrl('query', (0, _encodeQueryString.default)(query, params)));
  ...
  render() {
    ...
    const hasResult = !error && !queryInProgress && typeof result !== 'undefined'; // Note that because of react-json-inspector, we need at least one
    ...
    return _react.default.createElement("div", {
    ...
    }, typeof url === 'string' && _react.default.createElement("span", null, "Query URL:", _react.default.createElement("input", {
    ...
    }, "Query time: ", queryTime, "ms (end-to-end: ", e2eTime, "ms)")), _react.default.createElement("div", {
      ...
      data: result,
      query: query
    }), Array.isArray(result) && result.length === 0 && _react.default.createElement(_NoResultsDialog.default, {
      query: query,
      dataset: dataset
